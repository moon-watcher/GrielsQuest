...
static void _loop_niveles ( u16 *to )
{
...
//		if ( i < 13 )
//		{
//			VDP_fillTileMapRect(APLAN, 0, x+4, y, 1, 2 );
//		}
	}
...
//		if ( joy1_pressed_dir &&  ambiente == 5 )
//		{
//			_tt_init ( );
//			tt_info.wait = 0;
//			tt_write ( NARRADOR, frases_find ( 1, 6 ) );
//		}
...
//
//   u8 *frase = frases_find ( 1, ambiente );
//	text_draw_sprites_x_centered ( frase, 6, 0 ); // texto arriba
//}
//
//
//
