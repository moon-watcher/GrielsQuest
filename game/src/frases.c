...
const static FRASE _list [ ] =
{
	...
	(FRASE) { ENGLISH,   2, "\\ RESUME" },       // 0
	(FRASE) { ENGLISH,   2, "  RESTART" },       // 1
	(FRASE) { ENGLISH,   2, "  GIVE UP" },       // 2
	(FRASE) { ENGLISH,   2, "RESTART LEVEL" },   // 3
	(FRASE) { ENGLISH,   2, "GIVE UP LEVEL" },   // 4
	(FRASE) { ENGLISH,   2, "STAGE CLEAR" },     // 5
