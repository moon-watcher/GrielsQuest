...
const LEVEL w3r11 =
{
   ...
   (Image *) &w3_marco_1,
   {
      ...
      {     KEY,   PLESI,   SWORD,  PIRATA,   CROSS,  PIRATA,   SWORD,   PLESI,   SWORD,   PLESI,       0,       0,       0,CARACOLA,   PLESI,   PLESI },
      {       0,   STAFF,   PLESI,   SWORD,  PIRATA,   SWORD,   PLESI,   STAFF,   PLESI,CARACOLA,CARACOLA,       0,       0,CARACOLA,   PLESI,   STAFF },
      {       0,       0,   STAFF,   PLESI,   SWORD,   PLESI,   STAFF,   PLESI,   SWORD,   PLESI,CARACOLA,       0,CARACOLA,   PLESI,   PLESI,       0 },
      {       0,       0,       0,   STAFF,   PLESI,   STAFF,       0,   STAFF,   PLESI,   SWORD,   PLESI,CARACOLA,   PLESI,   SWORD,   PLESI,   STAFF },
      {       0,       0,       0,   PLESI,   SWORD,   PLESI,       0,       0,   STAFF,   PLESI,   STAFF,   PLESI,CARACOLA,CARACOLA,   PLESI,       0 },
      {       0,   SWORD,       0,       0,   PLESI,   STAFF,       0,       0,  PIRATA,   SWORD,   PLESI,   SWORD,   PLESI,   SWORD,   PLESI,       0 },
      {       0,       0,   STAFF,   PLESI,   SWORD,   PLESI,   STAFF,  PIRATA,   CROSS,  PIRATA,   SWORD,   PLESI,   STAFF,  PIRATA,   STAFF,CARACOLA },
