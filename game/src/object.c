...
#define OBJECT_IS_OVER     ABBAYE_U, ABBAYE_U_2, BIGTREE1_U, FISH21, TOTEM_1, BIGTREE4_U, ENEMY_DEAD, REMOVE_OBJECT, GUITAR1, ABBAYE_U_5, SARCOFAGO1, ORUS1, ESTRELLITA1, ESTRELLITA2, ESTRELLITA3, ESTRELLITA4, MURCIANO1, MURCIANO2
...
#define OBJECT_IS_BLOCK    BLOCK, \
                             ...
                             CRUZPY,   ESCARABAJO, BLOQUEPY,   GATOPY,     CUADRADOPY,  ORUS2,       SARCOFAGO2,  ESFINGE1,  ESFINGE2,   ESFINGE3,  ESFINGE4,  VASIJA,    CANDLEPY,                         \
                             SEASTAR,  TOMB4,      TORCH4,     TOTEM_2,    BIGTREE4_D,  STONE41,     STONE41,     SETO4,     SEASTAR,    ANCLA,     CARACOLA,  BIGPLESI1, BIGPLESI2, BIGPLESI3,  BIGPLESI4, \
                             GUITAR2,  BARREL,     TORCH5,     ABBAYE_D_5, BAFFLE,      MEGADRIVE,   BEER,        SOFA1,     SOFA2,      MURCIANO3, MURCIANO4
